   <body>
        ...
        <form role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/acara/update_action" " method="post" id="select">
       </div>
       
       <div class="form-group">
            <label for="varchar"> Tanggal</label>
            <div class='input-group date' id='datetimepicker11'>
                <input type='text' class="form-control input-lg" name="tgl_acara" placeholder="Tanggal" value="<?php echo $tgl_acara; ?>" />
	    ...
	    <div class="form-group">
            ...
            <div class='input-group time' id='timepicker'>
                <input type='time' class="form-control input-lg" name="waktu_acara" placeholder="Waktu" value="<?php echo $waktu_acara; ?>"/>
                <span class="input-group-addon">
	    ...
	    <div class="form-group">
            ...
            <select class="form-control" name="nama_genre" id="nama_genre" value="<?php echo $gambar; ?>">

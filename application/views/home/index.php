	   ...
	   <div class="section primary-section" id="service">
		...
		<!-- Contact section start -->
			...
			<div class="container">
				<div class="title">
					<h1>Who We Are?</h1>
					<p>Everything you do now is for your future. Think about that</p>
				</div>
				<div class="row-fluid team">
					<div class="span4" id="first-person">
						<div class="thumbnail">
							<img src="<?php echo base_url();?>assets/home/images/bila1.png" alt="team 1">
							<ul class="social">
								<li>
									<a href="">
							...
							<div class="mask">
								<h2>Nabilla M Basharahil</h2>  
								<h3>Back End Programer</h3>
							</div>
						</div>
					</div>
					<div class="span4" id="second-person">
						<div class="thumbnail">
							<img src="<?php echo base_url();?>assets/home/images/lipi.jpg" alt="team 1">
							<ul class="social">
								<li>
									<a href="">
										<span class="icon-facebook-circled"></span>
							...
							<div class="mask">
								<h2>Alifia Putri Ramadhani</h2>
								<h3>Front End Programer</h3>
							</div>
						</div>
					</div>
					<div class="span4" id="third-person">
						<div class="thumbnail">
							<img src="<?php echo base_url();?>assets/home/images/erma1.jpg" alt="team 1">
							<ul class="social">
								<li>
									<a href="">
										<span class="icon-facebook-circled"></span>
							...
							<div class="mask">
								<h2>Erma Rohmawati</h2>
								<h3> Database and System Analyst </h3>
							</div>
						</div>
					</div>
				</div>
				<div class="about-text centered">
					...
					<p>SMK Telkom Malang - Attitude is Everything</p>
				</div>
				<h3>Skills</h3>
				<div class="row-fluid">
					<div class="span6">
					...
					<div class="span6">
							<img src="<?php echo base_url();?>assets/home/images/telkom.jpg">
					</div>
				</div>
			</div>
		</div>
